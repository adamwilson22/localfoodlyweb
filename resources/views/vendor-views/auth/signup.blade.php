...
<main id="content" role="main" class="main">
    <div class="bg-img-hero login-bg" style="background-image: url({{asset('public/assets/admin')}}/img/MaskGroup17.png);">
    </div>
                        ...
                        <div class="">
                            <div class="">
                                <div class="mb-5">
                                    ...
                                    <p>Please Enter Your Number To Recieve Verification Code</p>
                                </div>
                            </div>
                            <!-- Form -->
                            <form class="login_form" action="{{route('vendor.auth.registerAndVerify')}}" method="post" id="vendor_login_form">
                                @csrf
                                <!-- Form Group -->
                                ...
                                <div class="js-form-message form-group">
                                    ...
                                    <label class="input-label" for="" hidden>Country Code *</label>
                                    <input type="text" id="country_code" class="form-control form-control-lg" name="country_code"
                                            placeholder="+1 222 333 4444" hidden >
                                <!-- End Form Group -->
                                ...
                                <button type="submit" class="btn btn-lg btn-primary mb-5">Next</button>
                               
                                <p>Already Have An Account? <a href="{{route('vendor.auth.login')}}">Login</a></p>
...
<script>
    $(document).on('ready', function () {
        ...
        const myTimeout = setTimeout(countrycode, 3000);
    ...
    // $('.selected-dial-code').on('click', function(){
    //     $('#country_code').val($('.selected-dial-code').text());
    // });
    ...
    $('li.country').on('click', function(){
        setTimeout(() => {
            // alert($('li.active').data('dial-code'));      
            $('#country_code').val($('li.active').data('dial-code'));
        }, 1000);
    });
</script>
