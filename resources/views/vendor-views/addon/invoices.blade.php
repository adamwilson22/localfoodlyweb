        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="all-invoices-tab" data-toggle="tab" href="#all-invoices" role="tab" aria-controls="all-invoices" aria-selected="true">All Invoices</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="open-invoices-tab" data-toggle="tab" href="#open-invoices" role="tab" aria-controls="open-invoices" aria-selected="false">Open Invoices</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="past-invoices-tab" data-toggle="tab" href="#past-invoices" role="tab" aria-controls="past-invoices" aria-selected="false">Past Invoices</a>
                    </li>
                </ul>
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="past-invoices" role="tabpanel" aria-labelledby="past-invoices-tab">
                        <div class="card">
                            <div class="card-body">
                                <div class="">
                                    <div class="table-responsive">
