                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="contact">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <a href="tel:+10000000000"><i class="icon-phone"></i> {{$customer->phone}}</a>
                                            </div>
                                            <div class="col-lg-6">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Please Select A Coupon</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control form-control-lg" placeholder="Select Coupon">
                    </div>
