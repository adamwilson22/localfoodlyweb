...
<body class="">
    @section('content')
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-6">
                            <div class="product-detail">
                                ...
                                <div>
                                    <a href="#" class="btn btn-primary btn-lg w-100" data-toggle="modal"
                                        data-target="#sharedModalCenter">Share This Product</a>
                                </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="product-cards detail-pro">
                                ...
                                <form action="{{ route('vendor.addon.product.destroy', $product->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
        ...
        <!-- Modal -->
        <div class="modal fade" id="sharedModalCenter" tabindex="-1" role="dialog"
            aria-labelledby="sharedModalCenterTitle" aria-hidden="true">
