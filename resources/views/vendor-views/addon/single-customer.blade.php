                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="single-detail">
                                    ...
                                    <h1>{{ $customerDetails->customer_name }}</h1>
                                    <h4>Customer</h4>
                                    <div class="contact">
                        ...
                        <div class="card">
                            <div class="card-body seller-card">
                                ...
                                <ul class="list-group list-group-flush selling-list">
                                    ...
                                    <li class="list-group-item">
                                        <div class="info">
                                            <img src="{{ asset('public/assets/admin/img/top-selling/top2.png') }}"
                                                alt="">
                                            <span>
                                                <h4>Classic Salad</h4>
                                                <p>Lorem ipsum dolor sit</p>
                                    ...
                                    <li class="list-group-item">
                                        <div class="info">
                                            <img src="{{ asset('public/assets/admin/img/top-selling/top3.png') }}"
                                                alt="">
                                            <span>
                                                <h4>Egg Sandwich</h4>
                                                <p>Lorem ipsum dolor sit</p>
                                    ...
                                    <li class="list-group-item">
                                        <div class="info">
                                            <img src="{{ asset('public/assets/admin/img/top-selling/top4.png') }}"
                                                alt="">
                                            <span>
                                                <h4>Muesil Mango</h4>
                                                <p>Lorem ipsum dolor sit</p>
