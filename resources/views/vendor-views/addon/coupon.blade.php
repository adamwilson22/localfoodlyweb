            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="all-coupons-tab" data-toggle="tab" href="#all-coupons"
                                role="tab" aria-controls="all-coupons" aria-selected="true">All Coupons</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="available-coupons-tab" data-toggle="tab" href="#available-coupons"
                                role="tab" aria-controls="available-coupons" aria-selected="false">Available Coupons</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="expired-coupon-tab" data-toggle="tab" href="#expired-coupon"
                                role="tab" aria-controls="expired-coupon" aria-selected="false">Expired Coupon</a>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="all-coupons" role="tabpanel"
                            aria-labelledby="all-coupons-tab">
                            <div class="card">
                                <div class="card-body">
                                    <div class="">
                        ...
                        <div class="tab-pane fade" id="available-coupons" role="tabpanel"
                            aria-labelledby="available-coupons-tab">
                            <div class="card">
                                <div class="card-body">
                                    <div class="">
                                        <div class="table-responsive">
                        ...
                        <div class="tab-pane fade" id="expired-coupon" role="tabpanel"
                            aria-labelledby="expired-coupon-tab">
                            <div class="card">
                                <div class="card-body">
                                    <div class="">
                                        <div class="table-responsive">
