        ...
        <div class="row">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="info">
                                                        ...
                                                        <span>
                                                            <h4>{{ $order->customer->f_name ?? '' }} {{ $order->customer->l_name ?? '' }}</h4>
                        ...
                        <div style=" display:flex; justify-content: flex-end;" >
                            <a style="max-width:200px; display:flex; justify-content: center;" class="btn" href="{{route('vendor.order.list', ['status' =>'pending'])}}">All Pending Orders</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-5">
                        ...
                        <ul class="list-group list-group-flush selling-list">
                            ...
                            <li class="list-group-item">
                                ...
                                <div class="action-btn">
                                    <a href="#" class="edit" data-toggle="modal" data-id="{{$order->id}}" data-target="#customerModalCenter"><i class="icon-edit_icon"></i></a>
                ...
                <div style=" display:flex; justify-content: flex-end;" >
                    ...
                    <a style="max-width:200px; display:flex; justify-content: center; margin:50px 30px" class="btn" href="{{route('vendor.order.list', ['status' =>'confirmed'])}}">Confirmed Orders</a>
                </div>
                </div>
                <!-- <div class="card">
                    <div class="card-body seller-card">
  ...
  $('.edit').click(function(e) {
    ...
    $.ajax({
      ...
      success: function(order) {
        ...
        $('.customer-name').text(order.customer.f_name + ' ' + order.customer.l_name );
        $('.order-id').text('Order #' + order.id );
        $('.customer-type').text(order.customer.orders_count > 1 ? "Repeat" : "New" );
