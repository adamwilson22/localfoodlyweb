                ...
                <div class="col-lg-7 order-lg-1 order-2">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="product_forms" action="{{ route('vendor.addon.product.update', ['id' => $product->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <!-- Form Group -->
                                ...
                                <div class=" form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input name="in_stock" type="checkbox" class="custom-control-input"
                                            id="customControlInline" value="0" {{$product->in_stock == 0 ? 'checked' : ''}}>
