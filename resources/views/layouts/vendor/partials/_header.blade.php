<div id="headerMain" class="d-none">
    <header id="header"
        class="navbar navbar-expand-lg navbar-flush navbar-container navbar-bordered">
        <div class="navbar-nav-wrap">
            <div class="navbar-brand-wrapper d-none">
                <!-- Logo Div-->
                {{--@php($restaurant_logo = \App\CentralLogics\Helpers::get_restaurant_data()->logo)--}}
                @php($restaurant_logo = "abc.png")
            ...
            <div class="navbar-nav-wrap-content-left d-xl-none">
                ...
                <button type="button" class="js-navbar-vertical-aside-toggle-invoker close mr-3">
                    <i class="icon-align-justify navbar-vertical-aside-toggle-short-align" data-toggle="tooltip"
                        data-placement="right" title="Collapse"></i>
                    <i class="icon-align-justify navbar-vertical-aside-toggle-full-align"
                        ...
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle"
                                ...
                                data-hs-unfold-options='{
                                     "target": "#notiNavbarDropdown",
                                     "type": "css-animation"
                                   }'>
                                <i class="icon-notification"></i>
                            </a>

                            <div id="notiNavbarDropdown"
                                class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right navbar-dropdown-menu navbar-dropdown-account"
                                style="width: 16rem;">

                                <a class="dropdown-item" href="#">notification abc </a>
                            ...
                            <a class="js-hs-unfold-invoker navbar-dropdown-account-wrapper" href="javascript:;"
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img"
                                        onerror="this.src='{{ asset('public/assets/admin/img/160x160/img1.jpg') }}'"
                                        src="{{ asset('public/images/vendor') }}/{{ \App\CentralLogics\Helpers::get_loggedin_user()->image }}"
                                ...
                                <div class="dropdown-item-text">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <span
                                                class="card-title h5">{{ \App\CentralLogics\Helpers::get_loggedin_user()->f_name . " " . auth('vendor')->user()->l_name  }}</span>
                                            <span
