...
<main id="content" role="main" class="main">
    <div class="bg-img-hero login-bg" style="background-image: url({{asset('public/assets/admin')}}/img/MaskGroup10.png);">
    </div>
                ...
                <div class="section-padding">
                    ...
                    <div class="">
                        <div class="">
                            ...
                            <!-- Form -->
                            <form class="login_form" action="{{route('vendor.auth.registerVendor')}}" method="post" id="vendor_login_form">
                                @csrf
                                ...
                                <p>Don't Have An Account? <a href="{{route('admin.auth.login')}}">Sign Up</a></p>
