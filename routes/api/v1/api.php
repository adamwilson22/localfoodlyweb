...
use App\Http\Controllers\Api\V1\Vendor\PaymentSettingsController;
...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'Auth'], function () {
        ...
        Route::group(['prefix' => 'vendor'], function () {
            ...
            Route::post('register-verify', 'VendorLoginController@registerAndVerify');
            Route::post('verify-phone', 'VendorLoginController@verify_phone');
        });
    ...
    Route::group(['prefix' => 'vendor', 'namespace' => 'Vendor', 'middleware'=>['vendor.api']], function () {
        ...
        Route::get('get_product/{product_id}', [ProductController::class, "get_product_for_edit"]);
        Route::post('update_product/{product_id}', [ProductController::class, "update_product"]);
        Route::post('delete_product/{product_id}', [ProductController::class, "delete_product"]);

        // Product Routes End

        // Restaurant Routes Start
        Route::post("create_store", [RestaurantController::class, "create_store"]);
        Route::get("get_all_stores", [RestaurantController::class, "get_all_stores"]);
        Route::get("edit_store/{store_id}", [RestaurantController::class, "edit_store"]);
        Route::post("update_store/{store_id}", [RestaurantController::class, "update_store"]);
        // Restaurant Routes End


        // Route::get("/get_payment_settings", [PaymentSettingsController::class, "getPaymentSettings"]);
        // Route::post("/create_payment_settings", [PaymentSettingsController::class, "createPaymentSettings"]);
        // Route::get("/get_payment_settings_by_id/{payment_id}", [PaymentSettingsController::class, "getPaymentSettingsById"]);
        // Route::put("/update_payment_settings/{payment_id}", [PaymentSettingsController::class, "updatePaymentSettings"]);    
